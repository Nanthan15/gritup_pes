...
<body>
  <div id="preloader">
    <img src="./assests/Pre.gif"  alt="Loading..." style="width: 1000px; padding: 0px; margin: 0px;"/><br>
...
<section class="home" id="home" style="
    ...
    <section class="next">
        ...
        <div class="video">
          <video  poster="./assests/tum1.png" controls>
    ...
    <section class="per" id="cus">
      ...
      <section class="updates" id="up">
        ...
        <div class="row">
          ...
          <div class="column">
            <div class="card" style="height: 20px;" id="caa1">
