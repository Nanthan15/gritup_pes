...
<body>
    ...
    while($d = mysqli_fetch_assoc($r)){
        ...
        echo "<center><img src='user-png-33832.png' class='card-img-top' alt='...' style='height:100px;width:50%'>";
        echo "<div class='card-body'>";
        $ema = $d['email'];
        echo "<h5 class='card-title'>Student Admin</h5>";
        echo "<p class='card-text'>Student Name : ".$d['name']."</p>";
        echo "<p class='card-text'>Branch : ".$d['branch']."</p>";
        echo "<p class='card-text'>Semester : ".$d['semester']."</p>";
        echo "<p class='card-text'>Email : ".$d['email']."</p>";
        echo "<br>";
        if(isset($_SESSION['user'])){
        echo "<button class='btn btn-primary' type='submit'><a style='color:white' href='chat.php?stu=$ema'>Get in Touch</a></button>";
        }
